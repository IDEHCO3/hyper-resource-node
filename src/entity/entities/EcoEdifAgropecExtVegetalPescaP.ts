...
@Index("eco_edif_agropec_ext_vegetal_pesca_p_pkey", ["idObjeto"], {
  unique: true,
})
@Entity("eco_edif_agropec_ext_vegetal_pesca_p", { schema: "bcim" })
export class EcoEdifAgropecExtVegetalPescaP {
  ...
  @Column("character varying", {
    name: "tipoedifagropec",
    nullable: true,
    length: 50,
  })
  tipoedifagropec: string | null;
