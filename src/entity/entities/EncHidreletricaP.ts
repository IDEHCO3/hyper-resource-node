...
@Index("enc_hidreletrica_p_pkey", ["idObjeto"], { unique: true })
@Entity("enc_hidreletrica_p", { schema: "bcim" })
export class EncHidreletricaP {
  ...
  @Column("character varying", {
    name: "codigohidreletrica",
    nullable: true,
    length: 30,
  })
  codigohidreletrica: string | null;
