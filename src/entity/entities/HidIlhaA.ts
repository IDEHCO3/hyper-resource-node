...
@Index("hid_ilha_a_pkey", ["idObjeto"], { unique: true })
@Entity("hid_ilha_a", { schema: "bcim" })
export class HidIlhaA {
  ...
  @Column("character varying", { name: "tipoilha", nullable: true, length: 8 })
  tipoilha: string | null;
