...
@Index("hid_terreno_sujeito_inundacao_a_pkey", ["idObjeto"], { unique: true })
@Entity("hid_terreno_sujeito_inundacao_a", { schema: "bcim" })
export class HidTerrenoSujeitoInundacaoA {
  ...
  @Column("character varying", {
    name: "periodicidadeinunda",
    nullable: true,
    length: 20,
  })
  periodicidadeinunda: string | null;
