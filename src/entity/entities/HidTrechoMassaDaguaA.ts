...
@Index("hid_trecho_massa_dagua_a_pkey", ["idObjeto"], { unique: true })
@Entity("hid_trecho_massa_dagua_a", { schema: "bcim" })
export class HidTrechoMassaDaguaA {
  ...
  @Column("character varying", {
    name: "tipotrechomassa",
    nullable: true,
    length: 13,
  })
  tipotrechomassa: string | null;
