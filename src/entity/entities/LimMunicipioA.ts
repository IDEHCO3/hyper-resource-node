...
@Index("lim_municipio_a_pkey", ["idObjeto"], { unique: true })
@Entity("lim_municipio_a", { schema: "bcim" })
export class LimMunicipioA {
  ...
  @Column("integer", { name: "anodereferencia", nullable: true })
  anodereferencia: number | null;
