...
@Index("lim_unidade_protecao_integral_a_pkey", ["idObjeto"], { unique: true })
@Entity("lim_unidade_protecao_integral_a", { schema: "bcim" })
export class LimUnidadeProtecaoIntegralA {
  ...
  @Column("character varying", {
    name: "tipounidprotinteg",
    nullable: true,
    length: 100,
  })
  tipounidprotinteg: string | null;
