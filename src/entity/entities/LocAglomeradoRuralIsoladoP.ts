...
@Index("loc_aglomerado_rural_isolado_p_pkey", ["idObjeto"], { unique: true })
@Entity("loc_aglomerado_rural_isolado_p", { schema: "bcim" })
export class LocAglomeradoRuralIsoladoP {
  ...
  @Column("character varying", {
    name: "tipoaglomrurisol",
    nullable: true,
    length: 35,
  })
  tipoaglomrurisol: string | null;
