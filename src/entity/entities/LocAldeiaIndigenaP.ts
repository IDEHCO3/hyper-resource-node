...
@Index("loc_aldeia_indigena_p_pkey", ["idObjeto"], { unique: true })
@Entity("loc_aldeia_indigena_p", { schema: "bcim" })
export class LocAldeiaIndigenaP {
  ...
  terraindigena: string | null;

  @Column("character varying", { name: "etnia", nullable: true, length: 100 })
  etnia: string | null;
