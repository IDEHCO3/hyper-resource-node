...
@Index("rel_elemento_fisiografico_natural_l_pkey", ["idObjeto"], {
  unique: true,
})
@Entity("rel_elemento_fisiografico_natural_l", { schema: "bcim" })
export class RelElementoFisiograficoNaturalL {
