...
@Index("rel_elemento_fisiografico_natural_p_pkey", ["idObjeto"], {
  unique: true,
})
@Entity("rel_elemento_fisiografico_natural_p", { schema: "bcim" })
export class RelElementoFisiograficoNaturalP {
