...
@Index("rel_ponto_cotado_altimetrico_p_pkey", ["idObjeto"], { unique: true })
@Entity("rel_ponto_cotado_altimetrico_p", { schema: "bcim" })
export class RelPontoCotadoAltimetricoP {
  ...
  @Column("double precision", { name: "cota", nullable: true, precision: 53 })
  cota: number | null;
