...
@Index("tra_edif_const_portuaria_p_pkey", ["idObjeto"], { unique: true })
@Entity("tra_edif_const_portuaria_p", { schema: "bcim" })
export class TraEdifConstPortuariaP {
