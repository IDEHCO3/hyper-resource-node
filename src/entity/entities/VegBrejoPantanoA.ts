...
@Index("veg_brejo_pantano_a_pkey", ["idObjeto"], { unique: true })
@Entity("veg_brejo_pantano_a", { schema: "bcim" })
export class VegBrejoPantanoA {
  ...
  @Column("character varying", {
    name: "tipobrejopantano",
    nullable: true,
    length: 27,
  })
  tipobrejopantano: string | null;
